...
void shuffleTiles() {
                          ...
                          content: Column(
                            ...
                            children: <Widget>[
                              ListTile(
                                title: Text("Option 1"),
                                onTap: () async {
                                  // Sélectionner une image depuis les assets
                                  final imagePicker = ImagePicker();
                                  final pickedFile = await imagePicker.getImage(source: ImageSource.gallery);
                                  if (pickedFile != null) {
                                    setState(() {
                                      path_image_asset = pickedFile.path;
                                      Imageasset = true;
                                      ImageInternet = false;
                                    });
                                  }
  ...
  children: [
    ...
    SizedBox(width: 10),
    Text('Nombre de coups pour gagner depuis la position courante: $Nbcouppourgagner',
    ),
  ],
),
